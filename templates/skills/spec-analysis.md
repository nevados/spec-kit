...
**Auto-invoke when:** User asks to analyze, review, or validate a specification
document.
...
Perform rapid quality analysis of spec.md files to identify gaps, ambiguities,
and completeness issues before planning or implementation begins.

## Capabilities

1. **Completeness Check**
   - Verify all mandatory sections present (User Stories, Requirements, Success
     Criteria)
...
**Overall Score**: 8/10 **Status**: Ready with minor improvements

## Completeness (9/10)

✓ All mandatory sections present ✓ User stories prioritized ✗ Edge cases section
empty
...
✓ Most stories independently testable ⚠ US3 depends on US1 completion
